...
<div class="archivePage">
    ...
    {#if videos.length > 0}
        <section class="videoSection">
            <div class="videoHeading">
                <div><small>WATCH THE SEASON</small><h2>🎬 {activeYear} Season Films</h2></div>
    ...
    {#if moments.length > 0}
        <section class="gallerySection">
            <div class="galleryHeader"><div><small>SEASON MEMORIES</small><h2>📸 {activeYear} Photo Archive</h2></div><span>{moments.length} loaded</span></div>
