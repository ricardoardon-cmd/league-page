...
<div class="archivePage">
    ...
    {#if moments.length > 0}
        <section class="gallerySection">
            <div class="galleryHeader"><div><small>SEASON MEMORIES</small><h2>📸 {activeYear}</h2></div><span>{moments.length} loaded</span></div>
