...
<svelte:head><title>{activeYear} Season Archive | GGL</title></svelte:head>
...
<div class="archivePage">
    <nav class="yearNav" aria-label="Season archive years">
        ...
        <div class="yearButtons">
            {#each years as year}
                <button class:active={activeYear === year} onclick={() => selectYear(year)}>{year}</button>
            {/each}
        </div>
    </nav>
